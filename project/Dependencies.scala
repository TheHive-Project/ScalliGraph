...
object Dependencies {
  ...
  lazy val luceneBackwardCodecs    = "org.apache.lucene"             % "lucene-backward-codecs"             % "8.9.0"
  lazy val tinkerpop               = "org.apache.tinkerpop"          % "gremlin-core"                       % "3.5.1"         // align with janusgraph
  ...
  lazy val apacheConfiguration     = "org.apache.commons"            % "commons-configuration2"             % "2.7"
  ...
  lazy val jackson                 = "com.fasterxml.jackson.module" %% "jackson-module-scala"               % "2.12.2"
