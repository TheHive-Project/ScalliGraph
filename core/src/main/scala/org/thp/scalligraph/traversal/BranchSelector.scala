...
class BranchSelector[D, G, C <: Converter[D, G]](traversal: Traversal[D, G, C]) {
  def on[S](f: Traversal[D, G, C] => Traversal[_, S, _]) = new BranchSelectorOn[D, G, C, S, Nothing](traversal, f, Nil)
}

class BranchSelectorOn[D, G, C <: Converter[D, G], S, DD](
  ...
  def option[OD >: DD, GG, CC <: Converter[OD, GG]](o: S, f: Traversal[D, G, C] => Traversal[OD, GG, CC]) =
    new BranchSelectorOn[D, G, C, S, OD](
      traversal,
      on,
