...
class SortQuery(publicProperties: List[PublicProperty[_ <: Element, _]]) extends ParamQuery[InputSort] {
...
class FilterQuery(publicProperties: List[PublicProperty[_ <: Element, _]]) extends ParamQuery[InputFilter] {
