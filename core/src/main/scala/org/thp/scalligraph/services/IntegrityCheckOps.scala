...
//    case EntityAdded =>
//      context.system.scheduler.scheduleOnce(initialDelay, self, NeedCheck)(context.system.dispatcher)
//      ()
//    case NeedCheck if !needCheck =>
//      context.become(
//        receive(
//          needCheck = true,
//          timer orElse Some(context.system.scheduler.scheduleAtFixedRate(Duration.Zero, interval, self, Check)(context.system.dispatcher))
//        )
//      )
