...
//    def out[E <: Product: ru.TypeTag]: GremlinScala.Aux[Vertex, g.Labels] = g.out(ru.typeOf[E].typeSymbol.name.toString)
//    def outToE[E <: Product: ru.TypeTag]: GremlinScala.Aux[Edge, g.Labels]  = g.outE(ru.typeOf[E].typeSymbol.name.toString)
//    def in[E <: Product: ru.TypeTag]: GremlinScala.Aux[Vertex, g.Labels]  = g.in(ru.typeOf[E].typeSymbol.name.toString)
