...
// From https://github.com/JanusGraph/janusgraph/blob/v0.6.0/janusgraph-core/src/main/java/org/janusgraph/graphdb/tinkerpop/optimize/step/JanusGraphStep.java
// s/MultiDistinctOrderedIterator/MultiDistinctOrderedIteratorAcceptNull/g
/**
    ...
    public JanusGraphStepAcceptNull(final GraphStep<S, E> originalStep) {
        ...
        this.setIteratorSupplier(() -> {
            ...
            if (orders.isEmpty()) {
                ...
                return new MultiDistinctOrderedIteratorAcceptNull<>(lowLimit, highLimit, responses, orders);
            }
        });
    }
